...
COLOR_INIT = 6
--edt finish
function Board:init(x, y, level) --edit
    self.x = x
    self.y = y
    self.matches = {}
    self.level = level --edit start
...
self.ctr = 0
    ...
    --self:initializeTiles()  --edit finished
--end

function Board:initializeTiles(level) --edit
    self.tiles = {}
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            --table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(6))) --edited finish
        end
    end
    ...
    for y = 1, 8 do
        ...
        if matchNum >= 3 then
            ...
            for x = 8, 8 - matchNum + 1, -1 do
              if self.tiles[y][x].shiny == true then --edit start
                    self:shiny_blast('h', y)
                    for x_tile = 1,8 do
                      table.insert(match, self.tiles[y][x_tile])
                    end
